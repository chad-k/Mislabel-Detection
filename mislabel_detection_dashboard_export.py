...
- Optionally override if you prefer different rates
...
### When to Override Contamination Rates

**Override LOWER (More Conservative)** → Fewer anomalies flagged
- When you're seeing too many false alarms
- For high-precision applications requiring near-zero false positives
- When the automatic rate seems too aggressive

Example: App chose 10%, you set to 6%

**Override HIGHER (More Sensitive)** → More anomalies flagged  
- When real defects are being missed
- For safety-critical applications
- When the automatic rate seems too lenient

Example: App chose 8%, you set to 12%

**Leave Auto-Detected**
- When results match your domain knowledge
- When you want unbiased data-driven decisions
- When learning how well the system works
...
A: Look at the anomaly score distribution chart. The red line (threshold) should be in a gap or at a natural separation. If it looks like it's in the middle of the data, you can override it.
...
8. **Iterate** - if you adjust contamination, re-run and see how results change
